...
for K = 25:2:50
    ...
    Datasets_val{3} = importdata(filename,delimiterIn);

    filename = fullfile(addr,'class4_val.txt');
    Datasets_val{4} = importdata(filename,delimiterIn);
...
for ro = 1:rows
    for co = 1:cols
        ...
        x1 = X(1); y1 = X(2);
        dis = [];
        values_train = {Datasets_train{1},Datasets_train{2},Datasets_train{3},Datasets_train{4}};
...
% figure();
class1 = plot_class(1);class2 = plot_class(2);class3 = plot_class(3);class4 = plot_class(4);   
plot (class1(:,1),class1(:,2),'y.',class2(:,1),class2(:,2),'c.',class3(:,1),class3(:,2),'w.',class4(:,1),class4(:,2),'g.');

plot (Datasets_train{1}(:,1),Datasets_train{1}(:,2),'r.',Datasets_train{2}(:,1),Datasets_train{2}(:,2),'b.',Datasets_train{3}(:,1),Datasets_train{3}(:,2),'k.',Datasets_train{4}(:,1),Datasets_train{4}(:,2),'m.');
